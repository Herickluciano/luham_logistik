...
function Login() {
  ...
  // Si déjà connecté, rediriger automatiquement vers l'accueil
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // CORRECTION : Ajout de /login pour cibler la bonne route de votre API Express
    ...
    <div>
      ...
      <form onSubmit={handleLogin} className="container space-y-4">
        <div className="container-form">
          ...
          <p onClick={() => navigate("/register")} className="bas-logi">
            Entreprise
          </p>
        </div>
      </form>
      ...
      <div className="bas-login">
        ...
        <div>
          <p className="droit">&copy; 2026 . Tous droits réservés a <a href="https://luhamcode.com">https://luhamcode.com</a> <span className="credits">Design by <a href="https://facebook.com" target="_blank" rel="noreferrer">LuhamCode</a></span></p>
        </div>
      </div>
    </div>
  );
